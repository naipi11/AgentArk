...
2. 按平台选择安装包：
   - **Windows：** `AgentArk_0.6.4_x64-setup.exe`（推荐）或 `AgentArk_0.6.4_x64_en-US.msi`
   - **Apple 芯片 macOS：** `AgentArk_0.6.4_aarch64.dmg`
   - **Linux x64：** `AgentArk_0.6.4_amd64.AppImage`、`.deb` 或 `.rpm`
