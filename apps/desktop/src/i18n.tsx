...
type MessageKey =
  ...
  | 'tabs.status' | 'tabs.scan' | 'tabs.projects' | 'tabs.sessions' | 'tabs.search' | 'tabs.timeline' | 'tabs.quarantine' | 'tabs.transfer'
  ...
  | 'search.title' | 'search.placeholder' | 'search.submit' | 'search.searching' | 'search.noResults' | 'search.error' | 'search.open'
  | 'timeline.title' | 'timeline.untitled' | 'timeline.select' | 'timeline.rawProvenanceUnavailable'
...
const messages: Record<Locale, Record<MessageKey, string>> = {
  'en-US': {
    ...
    'search.title': 'Search archive', 'search.placeholder': 'Search messages, tools, and titles', 'search.submit': 'Search', 'search.searching': 'Searching…', 'search.noResults': 'No matching sessions found.', 'search.error': 'Search failed. Check your query and try again.', 'search.open': 'Open session',
    'timeline.title': 'Timeline', 'timeline.untitled': 'Untitled session', 'timeline.select': 'Select a session to inspect its timeline.', 'timeline.rawProvenanceUnavailable': 'Original source evidence is not available on this device.',
  ...
  'zh-CN': {
    ...
    'search.title': '搜索归档', 'search.placeholder': '搜索消息、工具调用和标题', 'search.submit': '搜索', 'search.searching': '搜索中…', 'search.noResults': '没有找到匹配的会话。', 'search.error': '搜索失败，请检查查询内容后重试。', 'search.open': '打开会话',
    'timeline.title': '时间线', 'timeline.untitled': '未命名会话', 'timeline.select': '请选择一个会话查看时间线。', 'timeline.rawProvenanceUnavailable': '此设备没有原始源证据。',
