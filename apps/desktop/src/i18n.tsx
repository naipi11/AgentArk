...
type MessageKey =
  ...
  | 'transfer.title' | 'transfer.export' | 'transfer.import' | 'transfer.restore' | 'transfer.agent' | 'transfer.projects' | 'transfer.files' | 'transfer.noProjects' | 'transfer.preview' | 'transfer.conflicts' | 'transfer.path' | 'transfer.placeholder' | 'transfer.exporting' | 'transfer.importing' | 'transfer.restoring' | 'transfer.automaticRecovery' | 'transfer.outcomeSummary' | 'transfer.nativeIdentitySummary' | 'transfer.continuationSummary' | 'transfer.archiveOnlySummary' | 'transfer.recoveryDiagnostics' | 'transfer.recoveryDiagnosticsUnavailable' | 'transfer.manualInterventionSummary';
...
const messages: Record<Locale, Record<MessageKey, string>> = {
  'en-US': {
    ...
    'transfer.title': 'Session history transfer', 'transfer.export': 'Export session history', 'transfer.import': 'Import session history', 'transfer.restore': 'Restore imported history', 'transfer.agent': 'Export Agent', 'transfer.projects': 'Projects to include', 'transfer.files': 'Include project files', 'transfer.noProjects': 'No projects for this Agent.', 'transfer.preview': 'Verified bundle', 'transfer.conflicts': 'Conflicts', 'transfer.path': 'Selected bundle path', 'transfer.placeholder': 'Choose a destination or an .ahbundle file with the buttons below', 'transfer.exporting': 'Exporting…', 'transfer.importing': 'Checking…', 'transfer.restoring': 'Restoring…', 'transfer.automaticRecovery': 'AgentArk automatically retains compatible original sessions or creates continuations.', 'transfer.outcomeSummary': 'Recovery outcome', 'transfer.nativeIdentitySummary': '{count} original sessions retained', 'transfer.continuationSummary': '{count} continuation created', 'transfer.archiveOnlySummary': '{count} available in AgentArk archive only', 'transfer.recoveryDiagnostics': 'Recovery diagnostics', 'transfer.recoveryDiagnosticsUnavailable': 'Recovery diagnostics unavailable.', 'transfer.manualInterventionSummary': '{count} session needs manual intervention',
  },
  'zh-CN': {
    ...
    'transfer.title': '会话历史迁移', 'transfer.export': '导出会话历史', 'transfer.import': '导入会话历史', 'transfer.restore': '恢复导入的历史', 'transfer.agent': '导出 Agent', 'transfer.projects': '包含的项目', 'transfer.files': '包含项目文件', 'transfer.noProjects': '该 Agent 没有项目。', 'transfer.preview': '备份校验通过', 'transfer.conflicts': '冲突', 'transfer.path': '已选择的备份路径', 'transfer.placeholder': '请使用下方按钮选择保存位置或 .ahbundle 文件', 'transfer.exporting': '正在导出…', 'transfer.importing': '正在校验…', 'transfer.restoring': '正在恢复…', 'transfer.automaticRecovery': 'AgentArk 会自动保留兼容的原始会话，或创建延续会话。', 'transfer.outcomeSummary': '恢复结果', 'transfer.nativeIdentitySummary': '已保留 {count} 个原始会话', 'transfer.continuationSummary': '已创建 {count} 个延续会话', 'transfer.archiveOnlySummary': '{count} 个会话仅在 AgentArk 归档中可用', 'transfer.recoveryDiagnostics': '恢复诊断信息', 'transfer.recoveryDiagnosticsUnavailable': '恢复诊断信息不可用。', 'transfer.manualInterventionSummary': '{count} 个会话需要手动处理',
  },
};
