...
type Tab = 'status' | 'scan' | 'projects' | 'sessions' | 'search' | 'timeline' | 'quarantine' | 'transfer';
...
export function App() {
  ...
  const tabs: [Tab, string][] = [['status', t('tabs.status')], ['scan', t('tabs.scan')], ['projects', t('tabs.projects')], ['sessions', t('tabs.sessions')], ['search', t('tabs.search')], ['timeline', t('tabs.timeline')], ['transfer', t('tabs.transfer')], ['quarantine', t('tabs.quarantine')]];
  return (
